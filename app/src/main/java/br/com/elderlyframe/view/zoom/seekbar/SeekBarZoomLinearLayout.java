...
public class SeekBarZoomLinearLayout extends LinearLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBarZoomLinearLayout(@NonNull Context context) {
        super(context);
        init(context);
    }

    public SeekBarZoomLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SeekBarZoomLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void addView(final View view) {
        ...
        if (getChildCount() > 1) {
            throw new IllegalStateException("SeekBarLinearLayout can host only one direct child!");
        }
